...
class Transform(nn.Module):
    def __init__(self,k_transform):
        ...
        self.conv2 = nn.Conv1d(64,128,1)
        self.conv3 = nn.Conv1d(128,1024,1) # 1024 initial


        self.bn1 = nn.BatchNorm1d(64)
        self.bn2 = nn.BatchNorm1d(128)
        self.bn3 = nn.BatchNorm1d(1024) #1024 initial
...
class PointNet(nn.Module):
    def __init__(self, num_classes ,nr_features):
        ...
        self.RGCNN_conv=conv.DenseChebConv(6,6,3)
    ...
    def forward(self, input):
        ...
        with torch.no_grad():
            L = conv.pairwise_distance(input) # W - weight matrix
        ...
        out = self.RGCNN_conv(input, L)
        out = self.relu_rgcnn(out)

        out=out.transpose(1,2)

        xb, matrix3x3, matrix64x64 = self.transform(out)
