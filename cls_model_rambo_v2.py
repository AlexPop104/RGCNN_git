...
def train(model, optimizer, loader, regularization):
    ...
    for i, data in enumerate(loader):
        ...
        loss = compute_loss(logits, data.y, out, L, s=regularization)
        loss.backward()
        optimizer.step()
...
if __name__ == '__main__':
    ...
    parent_directory = "/home/victor/workspace/thesis_ws/github/RGCNN_git/models/ModelNet/"
    ...
    for epoch in range(1, 51):
        ...
        if epoch % 5 == 0:
            torch.save(model.state_dict(), path + '/1024_40_chebconv_model' + str(epoch) + '.pt')