...
#include <pcl_tutorial/compute_surface_normals_nodeConfig.h>
                              ...
                              pcl::PointCloud<pcl::PointNormal> &cloudnormals)
{
  ...
  void
  dynReconfCallback(pcl_tutorial::compute_surface_normals_nodeConfig &config, uint32_t level)
  {
...
private:
  ...
  dynamic_reconfigure::Server<pcl_tutorial::compute_surface_normals_nodeConfig> config_server_;
