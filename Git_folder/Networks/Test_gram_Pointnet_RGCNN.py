...
def train(model, optimizer, loader,nr_points):
    ...
    for i, data in enumerate(loader):
        ...
        elif (model.transform.input_transform.k==3):
            x = data.pos
            x=x.to(device)
            x=torch.reshape(x,(batch_size,nr_points,x.shape[1]))
        ...
        outputs, m3x3, m64x64 = model(gram.transpose(1,2))
...
def test(model, loader,nr_points):
    ...
    for i, data in enumerate(loader):
        ...
        outputs, __, __ = model(gram.transpose(1,2))
...
path_saved_model="/home/alex/Alex_documents/RGCNN_git/Git_folder/Trained+models/Rot_invariant/gram_PointnetRGCNN_512.pt"
