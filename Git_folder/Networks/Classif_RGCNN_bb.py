...
if(selection==1):
    ...
    for epoch in range(0, num_epochs+1):
        ...
        if(epoch%3==0):
            torch.save(model.state_dict(), path + '/RGCNN_bb_Rotation'+str(num_points)+"_" + str(epoch) + '.pt')
    ...
    for epoch in range(0, num_epochs+1):
        ...
        if(epoch%3==0):
            torch.save(model.state_dict(), path + '/RGCNN_bb_Pos_noise'+str(num_points)+"_" + str(epoch) + '.pt')
...
if(selection==4):
    ...
    for epoch in range(0, num_epochs+1):
        ...
        if(epoch%3==0):
            torch.save(model.state_dict(), path + '/RGCNN_bb_Occlusion'+str(num_points)+"_" + str(epoch) + '.pt')
