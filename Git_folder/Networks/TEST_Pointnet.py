...
path_saved_model="/home/alex/Alex_documents/RGCNN_git/Git_folder/Trained+models/No noise_train/Pointnet_6_512.pt"
...
###############################################################################################
print("-----------------------Pointnet trained on "+ str(num_points)+" points--------------")
