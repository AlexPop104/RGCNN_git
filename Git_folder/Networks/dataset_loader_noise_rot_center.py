...
if __name__ == '__main__':
    ...
    num_points = 512
    root = Path("/media/rambo/ssd2/Alex_data/RGCNN/PCD_DATA/Normals/Tests_2/Modelnet40_512/")

    #root_noise_1 = Path("/media/rambo/ssd2/Alex_data/RGCNN/PCD_DATA/Normals/Modelnet40_"+str(num_points)+"_r_40"+"/")
    root_noise_1 = Path("/media/rambo/ssd2/Alex_data/RGCNN/PCD_DATA/Normals/Occlusion/Modelnet40_occlusion_512_025/")
