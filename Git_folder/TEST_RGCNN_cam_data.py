...
path_saved_model="/home/alex/Alex_documents/RGCNN_git/Git_folder/Trained+models/Modelnet_40_RGCNN.pt"
...
###############################################################################################
print("-----------------------RGCNN 3 Layers trained on 1024 points--------------")

print("Modelnet40 points No noise accuracy 2048-1024-512")
num_points=2048
...
num_points=1024
root = Path("/media/rambo/ssd2/Alex_data/RGCNN/PCD_DATA/Normals/Modelnet40_1024/")
test_dataset = cam_loader.PcdDataset(root_dir=root, valid=True, folder='test',points=num_points)
test_loader  = DataLoader(test_dataset, batch_size=batch_size)
...
num_points=512
root = Path("/media/rambo/ssd2/Alex_data/RGCNN/PCD_DATA/Normals/Modelnet40_512/")
test_dataset = cam_loader.PcdDataset(root_dir=root, valid=True, folder='test',points=num_points)
test_loader  = DataLoader(test_dataset, batch_size=batch_size)
...
#print("Modelnet40 512 points No noise accuracy")
num_points=256
root = Path("/media/rambo/ssd2/Alex_data/RGCNN/PCD_DATA/Normals/Modelnet40_256/")
test_dataset = cam_loader.PcdDataset(root_dir=root, valid=True, folder='test',points=num_points)
test_loader  = DataLoader(test_dataset, batch_size=batch_size)
...
#print("Modelnet40 512 points No noise accuracy")
num_points=128
root = Path("/media/rambo/ssd2/Alex_data/RGCNN/PCD_DATA/Normals/Modelnet40_128/")
test_dataset = cam_loader.PcdDataset(root_dir=root, valid=True, folder='test',points=num_points)
test_loader  = DataLoader(test_dataset, batch_size=batch_size)
...
#print("Modelnet40 512 points No noise accuracy")
num_points=64
root = Path("/media/rambo/ssd2/Alex_data/RGCNN/PCD_DATA/Normals/Modelnet40_64/")
test_dataset = cam_loader.PcdDataset(root_dir=root, valid=True, folder='test',points=num_points)
test_loader  = DataLoader(test_dataset, batch_size=batch_size)
...
num_points=2048
root = Path("/media/rambo/ssd2/Alex_data/RGCNN/PCD_DATA/Normals/Modelnet40_2048_r_10/")
test_dataset = cam_loader.PcdDataset(root_dir=root, valid=True, folder='test',points=num_points)
test_loader  = DataLoader(test_dataset, batch_size=batch_size)
...
num_points=2048
root = Path("/media/rambo/ssd2/Alex_data/RGCNN/PCD_DATA/Normals/Modelnet40_2048_r_20/")
test_dataset = cam_loader.PcdDataset(root_dir=root, valid=True, folder='test',points=num_points)
test_loader  = DataLoader(test_dataset, batch_size=batch_size)
...
num_points=2048
root = Path("/media/rambo/ssd2/Alex_data/RGCNN/PCD_DATA/Normals/Modelnet40_2048_r_30/")
test_dataset = cam_loader.PcdDataset(root_dir=root, valid=True, folder='test',points=num_points)
test_loader  = DataLoader(test_dataset, batch_size=batch_size)
...
num_points=2048
root = Path("/media/rambo/ssd2/Alex_data/RGCNN/PCD_DATA/Normals/Modelnet40_2048_r_40/")
test_dataset = cam_loader.PcdDataset(root_dir=root, valid=True, folder='test',points=num_points)
test_loader  = DataLoader(test_dataset, batch_size=batch_size)
...
num_points=1024
root = Path("/media/rambo/ssd2/Alex_data/RGCNN/PCD_DATA/Normals/Modelnet40_1024_r_10/")
test_dataset = cam_loader.PcdDataset(root_dir=root, valid=True, folder='test',points=num_points)
test_loader  = DataLoader(test_dataset, batch_size=batch_size)
...
num_points=1024
root = Path("/media/rambo/ssd2/Alex_data/RGCNN/PCD_DATA/Normals/Modelnet40_1024_r_20/")
test_dataset = cam_loader.PcdDataset(root_dir=root, valid=True, folder='test',points=num_points)
test_loader  = DataLoader(test_dataset, batch_size=batch_size)
...
num_points=1024
root = Path("/media/rambo/ssd2/Alex_data/RGCNN/PCD_DATA/Normals/Modelnet40_1024_r_30/")
test_dataset = cam_loader.PcdDataset(root_dir=root, valid=True, folder='test',points=num_points)
test_loader  = DataLoader(test_dataset, batch_size=batch_size)
...
num_points=1024
root = Path("/media/rambo/ssd2/Alex_data/RGCNN/PCD_DATA/Normals/Modelnet40_1024_r_40/")
test_dataset = cam_loader.PcdDataset(root_dir=root, valid=True, folder='test',points=num_points)
test_loader  = DataLoader(test_dataset, batch_size=batch_size)
...
num_points=1024
root = Path("/media/rambo/ssd2/Alex_data/RGCNN/PCD_DATA/Normals/Modelnet40_1024_n_002/")
test_dataset = cam_loader.PcdDataset(root_dir=root, valid=True, folder='test',points=num_points)
test_loader  = DataLoader(test_dataset, batch_size=batch_size)
...
num_points=1024
root = Path("/media/rambo/ssd2/Alex_data/RGCNN/PCD_DATA/Normals/Modelnet40_1024_n_005/")
test_dataset = cam_loader.PcdDataset(root_dir=root, valid=True, folder='test',points=num_points)
test_loader  = DataLoader(test_dataset, batch_size=batch_size)
...
num_points=1024
root = Path("/media/rambo/ssd2/Alex_data/RGCNN/PCD_DATA/Normals/Modelnet40_1024_n_008/")
test_dataset = cam_loader.PcdDataset(root_dir=root, valid=True, folder='test',points=num_points)
test_loader  = DataLoader(test_dataset, batch_size=batch_size)
...
#print("Modelnet40 1024 points Position noise sigma=0.05 accuracy sampled normals")
num_points=1024
root = Path("/media/rambo/ssd2/Alex_data/RGCNN/PCD_DATA/Normals/Modelnet40_1024_n_010/")
test_dataset = cam_loader.PcdDataset(root_dir=root, valid=True, folder='test',points=num_points)
test_loader  = DataLoader(test_dataset, batch_size=batch_size)
